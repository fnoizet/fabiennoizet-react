export const fnData = {
	...
	"skills": {
		"functionnal": ["Analyse fonctionnelle", "Conception", "Développement", "Programmation objet", "Design patterns", "Outils de versionning", "Gestion SCRUM"],
		"technical": ["HTML", "Javascript", "Php", "Java", "ASP", "SQL", "CSS", "XML"]
	},
    "techLogos": ["html","css","javascript","jquery","php","phalcon","sql","xml","agile","scrum"],
    "experiences": [{
        "display": true,
		"companyLogoPath": "logo_next.jpg",
        "bgcolor": "#FFF",
        "color": "#F33",
		"company": "WHAT'S NEXT ?",
		...
		"job": "???",
		"desc": "Dans une équipe dynamique",
        "desc2": "Dans une équipe dynamique",
        "tasks": [
                "De la technique",
                "De la communication",
                "Du fun",
        ...
        "tags": ["Php", "Javascript", "Jquery", "Ajax", "Handlebars", "Windows", "HTML", "CSS", "API"]
	},{
        "display": true,
		...
		"job": "Développeur",
		"desc": "Dans une équipe de 3 développeurs, maintenance et évolution d'un ERP orienté éducation",
        "desc2": "Dans une équipe de 3 développeurs, maintenance et évolution d'un ERP à l'attention des universités et organismes de formation.",
        "tasks": [
                "Maintenance corrective et évolutive du framework",
                "Refonte de la suppression et restoration des fichiers",
                "Mise en place d'appel à l'API INSEE Siren",
                "Refonte de système de note libre / notation continue"
            ],
        "techEnv" : [
        ...
        "tags": ["Analyse fonctionnelle", "Scrum Master", "ScrumBan", "Agile", "Documentation technique", "Int&eacute;gration client API", "Gestion d'&eacute;quipe"]
	},
	{
		"display": true,
        ...
        "tags": ["Php", "Javascript", "Dojo", "Jquery", "Ajax", "Smarty", "Linux", "Windows", "Scrum Agile", "Rest", "SOAP", "HTML", "CSS", "API"]
	},
	{
		"display": true,
		...
		"job": "Développeur",
		"desc": "Dans un service informatique de 4 personnes, maintenance, optimisation et évolution d’un CRM pour une équipe commerciale de 40 personnes. Gestion de la vie d’un client, devis et commande. Mise à jour bidirectionnelle de base de données, Création d’outils spécifiques de gestion de demande de devis par email. Traitement par lots pour la mise à jour des stocks produits. Maintenance du site de la société et création du système de site vitrine configurable.",
		"desc2" : "Dans un service informatique de 4 personnes, maintenance, optimisation et évolution d’un CRM pour une équipe commerciale de 40 personnes.",
        "tasks" : [
        ...
        "tags": ["Php", "Javascript", "Jquery", "Ajax", "Windows", "HTML", "CSS", "SQL", "Batch"]
	},
	{
		"display": true,
		...
		"job": "Développeur",
		"desc": "Dans une équipe de 8 personnes, pour Amadeus SAS, création, maintenance et optimisation d’applications WEB de réservations de billet d’avion, et services annexes (choix du siège, repas). Rédaction de documents d’intégration. Création d’interface de communication AJAX / JSON et intégration aux applications des services propres au client.",
		"desc2" : "Dans une équipe de 8 personnes, pour Amadeus SAS, création, maintenance et optimisation d’applications WEB de réservations de billets d’avion.",
        "tasks" : [
		...
		"techEnv" : [
                "Java, JSTL, Javascript (JQuery), JSON",
                "MySql",
                "Windows"
            ],
        "tags": ["Java", "JSTL", "Javascript", "Jquery", "Ajax", "Windows", "SOAP", "HTML", "CSS"]
	},
	{
		"display": true,
		...
		"job": "Développeur",
		"desc": "Dans une équipe d'une dizaine de personnes, pour Orange et le site Voila.fr, créations de services WEB partagés disponibles pour tous les sites du groupe : système de vote, système de partage d'articles, système de validation par captcha. Développement de chaînes complètes pour les sites, générations de fichiers HTML avec  Smarty. Traitement par lots de flux xml et fichiers.",
		"desc2" : "Dans une équipe d'une dizaine de personnes, pour Orange et le site Voila.fr, créations de services WEB partagés disponibles pour tous les sites du groupe ORANGE.",
        "tasks" : [
        ...
        "tags": ["Php", "Javascript", "Dojo", "Ajax", "Smarty", "Linux", "Windows", "Rest", "SOAP", "HTML", "CSS", "API", "Batch", "SQL"]
	},
	{
		"display": true,
		...
		"job": "Développeur",
		"desc": "Dans une équipe de 5 personnes, interfaces Web dynamiques en Javascript et mise en place d'un système de normalisation des communications en XML pour une application de gestion d'événements, tâches et contacts. Test de charge et fonctionnalités, mise en place et spécifications pour un moteur de recherche intégré à cette même application.",
		"desc2" : "Dans une équipe de 5 personnes, développement d’une solution d’entreprise de gestion d'événements, tâches et contacts.",
        "tasks" : [
		...
		"techEnv" : [
                "Javascript (ExtJs), XML, JSON, Java",
                "Windows / Tomcat"
            ],
        "tags": ["Javascript", "ExtJs", "Java", "Windows", "SOAP", "HTML", "CSS", "XML"]
	},
	{
		"display": true,
		...
		"job": "Développeur",
		"desc": "Création de sites et applications WEB (site vitrine, Boutique en ligne, Intranet, Extranet). Analyse conception, réalisation des projets seul ou en équipe. Intégration des clients aux solutions techniques.",
		"desc2" : "Création de sites et applications WEB (site vitrine, Boutique en ligne, Intranet, Extranet). Analyse, conception et réalisation des projets seul ou en équipe.",
        "tasks" : [
        ...
        "tags": ["Php", "Asp", "Ajax", "Javascript", "Linux", "Windows", "HTML", "CSS", "SQL", "XML", "Apache"]
	}],
    "work": [
        {
            "name": "Custom checkbox",
            "type": "Graphics",
            "url": "/article/CustomCheckbox",
